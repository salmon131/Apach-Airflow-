...
- 태스크 간 복잡한 의존성 구조를 만들 수 있음
    ...
    <img src="images/Chapter 5 태스크 간 의존성 정의하기/Untitled.png">
...
<img src="images/Chapter 5 태스크 간 의존성 정의하기/Untitled 1.png">
...
- 단점)
    - 완전히 다른 태스크 체인이 필요한 경우 적용할 수 없다.
        ...
        <img src="images/Chapter 5 태스크 간 의존성 정의하기/Untitled 2.png">
        
    - DAG 실행 중에 Airflow에서 어떤 코드 분기를 사용하고 있는지 확인하기 어렵다.
        - 실제 브랜치가 작업 내에 숨겨져 있기 때문에 DAG 뷰는 이전과 달라지는 점이 없다.

<img src="images/Chapter 5 태스크 간 의존성 정의하기/Untitled 3.png">

### DAG 내부에서 브랜치하기

- 서로 다른 시스템에 각각 태스크 셋을 개발하고 DAG가 데이터 수집 작업을 어떤 시스템에서 실행할지 선택하도록 한다.

<img src="images/Chapter 5 태스크 간 의존성 정의하기/Untitled 4.png">
...
<img src="images/Chapter 5 태스크 간 의존성 정의하기/Untitled 5.png">
...
<img src="images/Chapter 5 태스크 간 의존성 정의하기/Untitled 6.png">
...
<조건부 태스크 추가 전><img src="images/Chapter 5 태스크 간 의존성 정의하기/Untitled 7.png">

<조건부 태스크 추가 후><img src="images/Chapter 5 태스크 간 의존성 정의하기/Untitled 8.png">
...
<img src="images/Chapter 5 태스크 간 의존성 정의하기/Untitled 9.png">
...
<img src="images/Chapter 5 태스크 간 의존성 정의하기/Untitled 10.png">
...
<img src="images/Chapter 5 태스크 간 의존성 정의하기/Untitled 11.png">
...
<img src="images/Chapter 5 태스크 간 의존성 정의하기/Untitled 12.png">
- 등록된 값은 Admin > XComs에서 확인 가능
- xcom_pull을 사용하여 다른 태스크에서도 XCom 값을 확인 가능
...
- Ex 2) PythonOperator 는 파이썬 호출 가능한 인수에서 반환된 값을 XCom 값으로 게시
    ...
    <img src="images/Chapter 5 태스크 간 의존성 정의하기/Untitled 13.png">
...
- **Taskflow API:**
    ...
    <img src="images/Chapter 5 태스크 간 의존성 정의하기/Untitled 14.png">
